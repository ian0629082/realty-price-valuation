...
- **行情地圖**：店面／住宅買賣與租賃成交、土地買賣成交、買賣投報率、預售屋等多種檢視模式，地圖上以色階呈現行情高低，並可依縣市／區域篩選。
- **視野即時行情**：畫面角落面板統計目前地圖可視範圍內的中位數、常見區間、區域比較。
- **土地評估試算**：輸入土地坪數、買價、容積率，自動計算總容積、土地倍數、土地單坪價、營造成本與預計售價；支援地號定位（自動帶入容積率）與地圖右鍵反查分區容積率；並比較鄰近 3km 預售建案售價。
