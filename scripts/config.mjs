...
export const SEASONS = [
  "114S1", "114S2", "114S3", "114S4", "115S1", "115S2",
];
export const CITY_FILE_PREFIX = "b"; // b = 臺中市
export const TARGET_DISTRICTS = ["南區", "大里區", "南屯區", "西屯區", "北屯區"];
...
export const DISTRICT_BOUNDS = {
  ...
  西屯區: { latMin: 24.155, latMax: 24.20, lngMin: 120.59, lngMax: 120.665 },
  北屯區: { latMin: 24.16, latMax: 24.24, lngMin: 120.68, lngMax: 120.76 },
};
